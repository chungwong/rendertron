...
export class FilesystemCache {
  ...
  cacheContent(key: string, ctx: Koa.Context) {
    ...
    fs.writeFileSync(path.join(this.getDir(key), this.cacheConfig.payloadFilename), payload);
    fs.writeFileSync(path.join(this.getDir(key), this.cacheConfig.responseFilename), JSON.stringify(response));
